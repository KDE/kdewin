/*** Autogenerated by WIDL 0.9.44 from dmodshow.idl - Do not edit ***/
#include <rpc.h>
#include <rpcndr.h>
...
#ifdef COBJMACROS
/*** IUnknown methods ***/
#define IDMOWrapperFilter_QueryInterface(p,a,b) (p)->lpVtbl->QueryInterface(p,a,b)
#define IDMOWrapperFilter_AddRef(p) (p)->lpVtbl->AddRef(p)
#define IDMOWrapperFilter_Release(p) (p)->lpVtbl->Release(p)
/*** IDMOWrapperFilter methods ***/
#define IDMOWrapperFilter_Init(p,a,b) (p)->lpVtbl->Init(p,a,b)
#endif

#endif

HRESULT CALLBACK IDMOWrapperFilter_Init_Proxy(
    IDMOWrapperFilter* This,
    REFCLSID clsidDMO,
    REFCLSID catDMO);
