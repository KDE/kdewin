...
#ifdef __MINGW__
#define CEPHES_INLINE __inline__
#elif _MSC_VER
#define CEPHES_INLINE __forceinline
#else
#define CEPHES_INLINE
#endif
 ...
 */
static  CEPHES_INLINE double polevl( x, p, n )
double x;
const void *p;
int n;
{
 ...
 */
static CEPHES_INLINE  double p1evl( x, p, n )
double x;
const void *p;
int n;
{
 ...
 *  P[0] x^n  +  P[1] x^(n-1)  +  ...  +  P[n]
 */
static  CEPHES_INLINE long double polevll( x, p, n )
long double x;
const void *p;
int n;
{
 ...
 *  x^n  +  P[0] x^(n-1)  +  P[1] x^(n-2)  +  ...  +  P[n]
 */
static CEPHES_INLINE long double p1evll( x, p, n )
long double x;
const void *p;
int n;
{
...
static CEPHES_INLINE float polevlf(float x, const float* coef, int N )
{
float ans;
float *p;
int i;
...
static CEPHES_INLINE float p1evlf( float x, const float *coef, int N )
{
float ans;
float *p;
int i;
