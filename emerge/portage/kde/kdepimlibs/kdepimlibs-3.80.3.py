...
SRC_URI = "ftp://ftp.kde.org/pub/kde/unstable/3.80.3/src/kdepimlibs-3.80.3.tar.bz2"
...
class subclass(base.baseclass):
  ...
  def compile( self ):
    ...
    options = "-DCMAKE_INSTALL_PREFIX=%s/kde ..\\%s-%s " % \
        ( self.cmakeInstallPrefix, self.package, self.version )
