...
class subclass(base.baseclass):
  ...
  def install( self ):
    ...
    command = r"""mingw32-make DESTDIR=%s install""" % self.imagedir
    print "inst comm", command
    os.system( command )
    
    os.chdir( self.imagedir )
    os.mkdir( "ThEtMpDiR" )
    os.system( "move secondroot\\kde ThEtMpDiR" )
    os.system( "rmdir secondroot" )
    os.system( "move ThEtMpDiR\\kde ." )
    os.system( "rmdir ThEtMpDiR" )
