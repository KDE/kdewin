...
:: Qt
if exist C:\Qt\4.2.0 set QTDIR=C:\QT\4.2.0
if exist C:\Qt\4.2.1 set QTDIR=C:\QT\4.2.1
if exist F:\Qt\4.2.0 set QTDIR=F:\QT\4.2.0
if exist F:\Qt\4.2.1 set QTDIR=F:\QT\4.2.1
if exist \Qt\4.2.0 set QTDIR=\QT\4.2.0
if exist \Qt\4.2.1 set QTDIR=\QT\4.2.1
if not %QTDIR%=="" (
